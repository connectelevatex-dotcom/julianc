  ...
  return (
    <footer className="py-6 md:py-12 bg-[#121a30] text-white relative z-10">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="my-6 md:my-8 flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
          ...
          <div>
            <button
              ...
              className="text-gray-300 hover:text-white bg-transparent border-none px-2 py-1 cursor-pointer duration-150"
        ...
        <span className="text-gray-400 block text-center text-xs sm:text-sm px-4"> © {new Date().getFullYear()} Julin Design, All rights reserved</span>
      </div>
    </footer>
  );
}
